...
public class TimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_time, parent, false);
    }
    ...
    public void addButtonOnClick(){
        Button selectTimeButton = (Button)getActivity().findViewById(R.id.selectTimeButton);
        ...
        Button manageTimeButton = (Button)getActivity().findViewById(R.id.manageTimeButton);
        ...
        Button editTimeButton = (Button)getActivity().findViewById(R.id.editTimeButton);
