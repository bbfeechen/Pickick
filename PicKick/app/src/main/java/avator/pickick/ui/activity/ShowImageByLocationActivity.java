...
import avator.pickick.ui.fragment.LocationFragment;
import avator.pickick.ws.remote.Config;


public class ShowImageByLocationActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            manager.beginTransaction()
                    .add(R.id.locationContainer, new LocationFragment())
                    .commit();
        }
   }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_show_image_by_location, menu);
        return true;
    }
